            ...
            callback:function(r){
                ...
                frappe.call({method:'ksa_eis.ksa_eis.doctype.zatca_csid.zatca_csid.generate_csid', args:{
                    ...
                    callback:function(r){
                        ...
                        frm.doc.request_id=jsonDoc.requestID
                        frm.doc.issue_date=frappe.datetime.nowdate()
                        frm.doc.expiry_date=frappe.datetime.add_days(frappe.datetime.nowdate(),365)
                        ...
                        frappe.call({method:'ksa_eis.ksa_eis.doctype.zatca_csid.zatca_csid.onboard_csid', args:{
                            ...
                            callback:function(r2){
                                ...
                                frm.doc.prod_request_id=jsonDoc2.requestID
                            }
        }
        )
                    }
